...
@RestController
public class KLipsumController {

    private List<String> klipsum;

    public KLipsumController(){
        initial();
    }
    ...
    @GetMapping("/klipsum")
    public Map<String, String> klipsum(HttpServletRequest httpServletRequest
            , @RequestParam int size){
        String resultString = String.join(" ", klipsum.subList(0,size));
